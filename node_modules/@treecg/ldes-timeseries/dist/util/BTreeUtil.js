...
exports.logMaximumMembersForDepth = exports.memberPerLayer = void 0;
/**
 ...
 */
function memberPerLayer(pageSize, layerSize, depth) {
    if (depth < 2) {
        return 0;
    }
    return Math.pow(layerSize, depth - 1) * pageSize;
}
exports.memberPerLayer = memberPerLayer;
/**
 * Logs the maximum amount of members per depth
 * @param pageSize - Maximum amount of members in a leaf node.
 * @param layerSize - Maximum amount of unique nodes that can be reached from a node.
 */
function logMaximumMembersForDepth(pageSize, layerSize) {
    // create range (1..n)
    const range = (n) => Array.from(Array(n), (_, i) => i + 1);
...
exports.logMaximumMembersForDepth = logMaximumMembersForDepth;
