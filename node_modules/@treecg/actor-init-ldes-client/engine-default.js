...
const https___linkedsoftwaredependencies_org_bundles_npm__treecg_bus_rdf_filter_object__3_0_0_components_ActorRdfFilterObject_jsonld_ActorRdfFilterObject_default_bus = new (require('@comunica/core').Bus)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@treecg/bus-rdf-filter-object/^3.0.0/components/ActorRdfFilterObject.jsonld#ActorRdfFilterObject_default_bus'
});
const https___linkedsoftwaredependencies_org_bundles_npm__treecg_bus_rdf_frame__3_0_0_components_ActorRdfFrame_jsonld_ActorRdfFrame_default_bus = new (require('@comunica/core').Bus)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@treecg/bus-rdf-frame/^3.0.0/components/ActorRdfFrame.jsonld#ActorRdfFrame_default_bus'
});
...
const urn_comunica_default_rdf_filter_object_mediators_filter = new (require('@comunica/mediator-race').MediatorRace)({
  'name': 'urn:comunica:default:rdf-filter-object/mediators#filter',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__treecg_bus_rdf_filter_object__3_0_0_components_ActorRdfFilterObject_jsonld_ActorRdfFilterObject_default_bus
});
...
const urn_comunica_default_rdf_frame_mediators_rdfFrame = new (require('@comunica/mediator-race').MediatorRace)({
  'name': 'urn:comunica:default:rdf-frame/mediators#rdfFrame',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__treecg_bus_rdf_frame__3_0_0_components_ActorRdfFrame_jsonld_ActorRdfFrame_default_bus
});
...
const urn_comunica_myLDESClient = new (require('./index.js').LDESClient)({
  'mediatorRdfMetadataExtractTree': urn_comunica_default_rdf_metadata_extract_mediators_main,
  'mediatorRdfParseHandle': urn_comunica_default_rdf_parse_mediators_parse,
  'mediatorRdfFilterObject': urn_comunica_default_rdf_filter_object_mediators_filter,
  'mediatorRdfFrame': urn_comunica_default_rdf_frame_mediators_rdfFrame,
  'mediatorRdfSerializeHandle': urn_comunica_default_rdf_serialize_mediators_serialize,
