...
class BaseResourcesGenerator {
    ...
    async *generateResource(link, options, metaLink) {
        ...
        if (!(0, PathUtil_1.isContainerIdentifier)(link.identifier) || !await this.store.hasResource(link.identifier)) {
        ...
        if (metaLink) {
            ...
            const descriptionMeta = new RepresentationMetadata_1.RepresentationMetadata(metaIdentifier);
            (0, ResourceUtil_1.addResourceMetadata)(rawMetadata, (0, PathUtil_1.isContainerIdentifier)(link.identifier));
            this.logger.debug(`Generating resource ${metaIdentifier.path}`);
            yield {
                identifier: metaIdentifier,
                representation: new BasicRepresentation_1.BasicRepresentation(rawMetadata.quads(), descriptionMeta, ContentTypes_1.INTERNAL_QUADS),
            };
        }
    }
    /**
    ...
    async processFile(link, contents) {
        ...
        return (0, GuardedStream_1.guardStream)((0, fs_1.createReadStream)(link.filePath));
    }
}
