...
class TemplatedPodGenerator {
    ...
    async generate(identifier, settings) {
        ...
        const store = await this.storeFactory.generate(variables[Variables_1.TEMPLATE_VARIABLE.templateConfig], Variables_1.TEMPLATE.ResourceStore, { ...variables, 'urn:solid-server:default:variable:baseUrl': this.baseUrl });
