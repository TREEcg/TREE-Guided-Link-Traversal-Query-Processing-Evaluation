...
function createTermNamespace(baseUri, ...localNames) {
    return createNamespace(baseUri, n3_1.DataFactory.namedNode, ...localNames);
}
...
exports.AS = createUriAndTermNamespace('https://www.w3.org/ns/activitystreams#', 'Create', 'Delete', 'Update');
...
exports.HH = createUriAndTermNamespace('http://www.w3.org/2011/http-headers#', 'content-length');
exports.HTTP = createUriAndTermNamespace('http://www.w3.org/2011/http#', 'statusCodeNumber');
exports.IANA = createUriAndTermNamespace('http://www.w3.org/ns/iana/media-types/');
exports.JSON_LD = createUriAndTermNamespace('http://www.w3.org/ns/json-ld#', 'context');
...
exports.RDFS = createUriAndTermNamespace('http://www.w3.org/2000/01/rdf-schema#', 'label');
exports.SOLID = createUriAndTermNamespace('http://www.w3.org/ns/solid/terms#', 'deletes', 'inserts', 'oidcIssuer', 'oidcIssuerRegistrationToken', 'oidcRegistration', 'where', 'InsertDeletePatch');
exports.SOLID_AS = createUriAndTermNamespace('http://www.w3.org/ns/solid/activitystreams#', 'Activity');
exports.SOLID_ERROR = createUriAndTermNamespace('urn:npm:solid:community-server:error:', 'disallowedMethod', 'errorResponse', 'stack');
