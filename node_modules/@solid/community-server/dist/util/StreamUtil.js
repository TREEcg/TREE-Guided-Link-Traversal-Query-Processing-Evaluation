...
exports.endOfStream = (0, util_1.promisify)(end_of_stream_1.default);
...
function guardedStreamFrom(contents, options) {
    return (0, GuardedStream_1.guardStream)(stream_1.Readable.from(typeof contents === 'string' ? [contents] : contents, options));
}
