 ...
 */
export declare function map<TIn, TOut>(iterable: Iterable<TIn>, callbackFn: (element: TIn, index: number) => TOut, thisArg?: any): Iterable<TOut>;
/**
 ...
 * @param thisArg - Value to use as `this` when executing `callbackFn`.
 */
export declare function filter<T>(iterable: Iterable<T>, callbackFn: (element: T, index: number) => boolean, thisArg?: any): Iterable<T>;
/**
 ...
 * @param thisArg - Value to use as `this` when executing `callbackFn`.
 */
export declare function find<T>(iterable: Iterable<T>, callbackFn: (element: T, index: number) => boolean, thisArg?: any): T | undefined;
/**
