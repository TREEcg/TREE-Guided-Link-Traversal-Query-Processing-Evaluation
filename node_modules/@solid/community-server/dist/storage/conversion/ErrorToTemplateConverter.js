    ...
    async handle({ representation }) {
        ...
        if (HttpError_1.HttpError.isInstance(error)) {
            try {
                ...
                (0, assert_1.default)((0, StringUtil_1.isValidFileName)(templateFile), 'Invalid error template name');
                description = await this.templateEngine.render(error.details ?? {}, { templateFile, templatePath: this.codeTemplatesPath });
            }
            catch {
