...
class FileDataAccessor {
    ...
    async getRawMetadata(identifier) {
        try {
            ...
            await (0, fs_extra_1.lstat)(metadataLink.filePath);
            const readMetadataStream = (0, GuardedStream_1.guardStream)((0, fs_extra_1.createReadStream)(metadataLink.filePath));
            return await (0, QuadUtil_1.parseQuads)(readMetadataStream, { format: metadataLink.contentType, baseIRI: identifier.path });
        }
        catch (error) {
