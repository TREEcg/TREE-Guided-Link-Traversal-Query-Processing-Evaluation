...
function assertPassword(password, confirmPassword) {
    (0, assert_1.default)(typeof password === 'string' && password.length > 0, 'Please enter a password.');
    (0, assert_1.default)(typeof confirmPassword === 'string' && confirmPassword.length > 0, 'Please confirm your password.');
    (0, assert_1.default)(password === confirmPassword, 'Your password and confirmation did not match.');
}
