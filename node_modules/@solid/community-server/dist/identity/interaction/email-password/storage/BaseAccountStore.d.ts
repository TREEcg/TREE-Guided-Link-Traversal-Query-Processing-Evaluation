...
export declare class BaseAccountStore implements AccountStore {
    ...
    private readonly forgotPasswordStorage;
    private readonly saltRounds;
    private readonly forgotPasswordExpiration;
    constructor(storage: KeyValueStorage<string, EmailPasswordData>, forgotPasswordStorage: ExpiringStorage<string, EmailPasswordData>, saltRounds: number, forgotPasswordExpiration?: number);
    /**
