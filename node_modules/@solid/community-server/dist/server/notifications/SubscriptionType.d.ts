 ...
 */
export interface SubscriptionType<TSub extends typeof SUBSCRIBE_SCHEMA = typeof SUBSCRIBE_SCHEMA, TFeat extends Record<string, unknown> = Record<string, unknown>> {
    /**
