...
class RouterHandler extends HttpHandler_1.HttpHandler {
    constructor(args) {
        super();
        this.baseUrl = (0, PathUtil_1.ensureTrailingSlash)(args.baseUrl);
    ...
    async canHandle(input) {
        ...
        if (!this.allMethods && !this.allowedMethods.includes(request.method)) {
            throw new MethodNotAllowedHttpError_1.MethodNotAllowedHttpError([request.method], `${request.method} is not allowed.`);
        }
        const pathName = await (0, PathUtil_1.getRelativeUrl)(this.baseUrl, request, this.targetExtractor);
