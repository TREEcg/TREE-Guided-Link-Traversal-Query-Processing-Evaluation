...
class StaticAssetHandler extends HttpHandler_1.HttpHandler {
    ...
    constructor(assets, baseUrl, options = {}) {
        ...
        for (const [url, path] of Object.entries(assets)) {
            this.mappings[(0, PathUtil_1.trimLeadingSlashes)(url)] = (0, PathUtil_1.resolveAssetPath)(path);
        }
    ...
    createPathMatcher(rootPath) {
        ...
        for (const path of paths) {
            (path.endsWith('/') ? folders : files).push((0, escape_string_regexp_1.default)(path));
        }
    ...
    async handle({ request, response }) {
        ...
        const asset = (0, fs_1.createReadStream)(filePath);
