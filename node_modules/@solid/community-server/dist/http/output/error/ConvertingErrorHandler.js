...
class ConvertingErrorHandler extends ErrorHandler_1.ErrorHandler {
    ...
    async extractErrorDetails({ error, request }) {
        const statusCode = (0, HttpErrorUtil_1.getStatusCode)(error);
    ...
    toRepresentation(error, statusCode) {
        ...
        metadata.add(Vocabularies_1.HTTP.terms.statusCodeNumber, (0, TermUtil_1.toLiteral)(statusCode, Vocabularies_1.XSD.terms.integer));
