...
class AllowAcceptHeaderWriter extends MetadataWriter_1.MetadataWriter {
     ...
     */
    isPostAllowed(metadata) {
        return metadata.has(Vocabularies_1.RDF.terms.type, Vocabularies_1.LDP.terms.Resource) && !(0, PathUtil_1.isContainerPath)(metadata.identifier.value);
    }
    /**
